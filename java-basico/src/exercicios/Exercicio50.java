...
/**
 * Programa para ler três valores e escrever a soma dos 2 maiores.
 * @author mtomazs
 * @since 09/02/2021
 */
public class Exercicio50 {
	...
	public static void main(String[] args) {
		...
		if ((n1 < n2) && (n1 < n3)) 
		{
		JOptionPane.showMessageDialog(null, "A soma dos 2 números maiores é: " + (n2 + n3));
		}
		
		else if ((n2 < n3) && (n2 < n1)) 
		{
		JOptionPane.showMessageDialog(null, "A soma dos 2 números maiores é: " + (n1 + n3));
		} 
		
		else 
		{
			JOptionPane.showMessageDialog(null, "A soma dos 2 números maiores é: " + (n2 + n1));	
		}
		}
